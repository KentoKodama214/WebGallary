...
| 項目 | 内容 |
|------|------|
| エンドポイント | `POST /api/v1/photos/favorites` |
| 概要 | 写真をお気に入りに登録する |
| 認証 | 必要 |
...
|-----------|-----|------|--------------|------|
| favoritePhotoAccountNo | Integer | Yes | 正の整数 | お気に入り対象の写真を所有するアカウント番号 |
| favoritePhotoNo | Integer | Yes | 正の整数 | お気に入り対象の写真番号 |
...
| 409 Conflict | E-P-0005 | お気に入り登録に失敗 |
